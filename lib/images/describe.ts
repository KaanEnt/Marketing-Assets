...
const DESCRIBE_MODEL = process.env.IMAGE_DESCRIBE_MODEL || "gemini-3.5-flash-lite";
 ...
 */
export async function describeImage(dataUri: string, signal?: AbortSignal): Promise<string> {
